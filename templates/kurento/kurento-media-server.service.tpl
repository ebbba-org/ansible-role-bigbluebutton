[Unit]
Description=Kurento Media Server daemon ({{ kms_port }})
...
Environment=KURENTO_CONF_FILE=/etc/kurento/kurento-{{ kms_port }}.conf.json
User=kurento
Group=kurento
LimitNOFILE=1000000
TasksMax=infinity
...
Type=simple
PIDFile=/var/run/kurento-media-server-{{ kms_port }}.pid
Restart=always
